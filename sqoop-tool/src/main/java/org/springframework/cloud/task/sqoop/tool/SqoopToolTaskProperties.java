...
/**
 * Configuration properties to be used by the SqoopToolRunner.
 *
 * @author Thomas Risberg
 */
@ConfigurationProperties
public class SqoopToolTaskProperties {
	...
	/**
	 * The Sqoop specific tool arguments as a complete String, passed as is to the command tool.
	 */
	...
	private boolean isSupportedCommand() {
		return (command != null && (command.equals("import") || command.equals("export")));
	}
}
