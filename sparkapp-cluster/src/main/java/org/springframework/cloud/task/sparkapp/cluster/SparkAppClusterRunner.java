 ...
 */
public class SparkAppClusterRunner implements CommandLineRunner {

	private static final Logger logger = LoggerFactory.getLogger(SparkAppClusterRunner.class);

	@Autowired
	private SparkAppClusterTaskProperties config;
